...
public class PeticaoRegistradaUnitTests {
	...
	public void devemSerConsideradosIguais() {
		PeticaoRegistrada evento1 = new PeticaoRegistrada(1L, "01/2016", "ADI", "ORIGINARIO");
		PeticaoRegistrada evento2 = new PeticaoRegistrada(1L, "01/2016", "ADI", "ORIGINARIO");
	...
	public void devemSerConsideradosDiferentes() {
		PeticaoRegistrada evento1 = new PeticaoRegistrada(1L, "01/2016", "ADI", "ORIGINARIO");
		PeticaoRegistrada evento2 = new PeticaoRegistrada(2L, "02/2016", "ADO", "ORIGINARIO");
